...
return [
    'BE' => [
        ...
        'installToolPassword' => '$pbkdf2-sha256$25000$a0x.G8P8DvvcXvC1l.0qFQ$juuU1KRsb6sxp6DFHqYMpObgB.8ufEaZfkdkZuWH7z0',
    ...
    'GFX' => [
        'jpg_quality' => '80',
        'processor_path' => '/usr/bin/php_safemode/',
        'processor_path_lzw' => '/usr/bin/php_safemode/',
    ],
    'MAIL' => [
        'transport' => 'sendmail',
